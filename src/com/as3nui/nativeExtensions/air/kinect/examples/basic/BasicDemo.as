package com.as3nui.nativeExtensions.air.kinect.examples.basic {
	...
	public class BasicDemo extends DemoBase {
		...
		protected var rgbSkeletonContainer:Sprite;
		protected var depthSkeletonContainer:Sprite;
		protected var skeletonContainer:Sprite;
...
//			for each(var user:User in device.users) {
				...
				changeDepthX(userCenterSprite.x);
